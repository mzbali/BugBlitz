      ...
      <ol className='mt-8 space-y-6'>
        ...
        <li className='space-y-2'>
          ...
          <div className='space-x-2'>
            ...
            <UnstyledLink href='https://mzbali.com'>Outside Links</UnstyledLink>
          </div>
        </li>
        <li className='space-y-2'>
          ...
          <div className='space-x-2'>
            ...
            <PrimaryLink href='https://mzbali.com'>Outside Links</PrimaryLink>
          </div>
        </li>
        <li className='space-y-2'>
        ...
        <li className='space-y-2'>
          ...
          <p className={clsx('!mt-1 text-sm', textColor)}>
            Useful for indicating navigation, I use this quite a lot, so why not
            build a component with some whimsy touch?
          </p>
        ...
        <li className='space-y-2'>
          ...
          <div className='flex flex-wrap gap-2'>
            <Button variant='primary' leftIcon={Plus} rightIcon={ArrowRight}>
              Icon
            </Button>
            <Button
              variant='outline'
