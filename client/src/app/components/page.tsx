                    ...
                    <ol className='mt-8 space-y-6'>
                        <li className='space-y-2'>
                            ...
                            <p className={clsx('!mt-1 text-sm', textColor)}>
                                You can change primary color to any Tailwind CSS
                                colors. See globals.css to change your color.
                            </p>
                        ...
                        <li className='space-y-2'>
                            ...
                            <p className={clsx('!mt-1 text-sm', textColor)}>
                                ...
                                outside links, give custom cursor for outside
                                links.
                            </p>
                        ...
                        <li className='space-y-2'>
                            ...
                            <p className={clsx('!mt-1 text-sm', textColor)}>
                                ...
                                quite a lot, so why not build a component with
                                some whimsy touch?
                            </p>
